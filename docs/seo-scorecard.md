...
| Stav sitemap v GSC | Uspesne, 45 objevenych stranek | GSC kontrola v prohlizeci 2026-05-26 | Presna historicka data nejsou exportovana do repozitare. |
| Indexace homepage | Indexovana | GSC kontrola v prohlizeci 2026-05-26 | U prioritnich URL bylo pozadano o indexovani. |
| GA4 | ID `G-BCXFMBWZJ4` v kodu | `script.js` | Realne reporty a konverze nejsou exportovane. |
...
| Google Business Profile | Nelze overit z repozitare | Neovereno | Majitel musi dodat stav nebo pristup/export. |
| Recenze | Nelze overit z repozitare | Neovereno | Zatim neevidovano. |
| Realne fotky | Nelze overit z repozitare | Neovereno | Nutne doplnovat postupne. |
