...
const locationPages = [
  ...
  { cz: "kontejnery-unhost.html", name: "Unhošť and Svárov", local: "Unhošť, Svárov, Červený Újezd, Ptice, Pavlov, Jeneč, Chýně and nearby villages", nearby: "Kladno, Rudná, Nučice and Prague-West", focus: "rubble removal, soil removal, garden waste and recycled aggregate delivery", note: "Svárov and Unhošť are among the closest service areas, which helps with practical route planning and quick communication." },
...
const footer = () => `<footer class="site-footer">
    ...
    <div class="mobile-cta"><a href="tel:+420738505028"><i data-lucide="phone" aria-hidden="true"></i>Call</a><a href="contact.html#form"><i data-lucide="send" aria-hidden="true"></i>Quote</a></div>`;
    ...
    const body = `<main id="top">
      ...
      <section class="section priority-area" aria-labelledby="priority-area-title">
        ...
        <div class="content-blocks">
          <article><h2>Frequently served towns</h2><p>Svárov, Unhošť, Červený Újezd, Ptice, Pavlov, Jeneč, Chýně, Rudná, Nučice, Hostivice, Braškov, Velká Dobrá and nearby Kladno areas.</p></article>
