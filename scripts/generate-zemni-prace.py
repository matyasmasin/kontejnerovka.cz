...
<html lang="cs">
  ...
  <body>
    <header class="site-header is-scrolled" data-header>
      ...
      <div class="header-actions"><div class="language-switcher" aria-label="Jazyk webu"><a class="is-active" href="/{p["file"]}" lang="cs" aria-current="page">CZ</a><span class="is-disabled" lang="en" aria-disabled="true" title="Anglická verze této stránky zatím není dostupná.">EN</span></div><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="site-nav" data-nav-toggle><i data-lucide="menu" aria-hidden="true"></i><span class="sr-only">Otevřít menu</span></button><a class="header-call" href="tel:+420728505028"><i data-lucide="phone" aria-hidden="true"></i>728&nbsp;505&nbsp;028</a></div>
    </header>
