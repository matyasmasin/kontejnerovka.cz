...
const footer = (footerText, secondaryLinks = []) => `<footer class="site-footer">
      ...
      <div><a href="tel:+420728505028">728&nbsp;505&nbsp;028</a><a href="mailto:info@kontejnerovka.cz">info@kontejnerovka.cz</a><a href="${GOOGLE_PROFILE}" target="_blank" rel="noopener">Google profil</a>${secondaryLinks.map(([label, href]) => `<a href="${href}">${label}</a>`).join("")}</div>
    </footer>`;
  ...
  <body>
    ...
    <main class="page-main">
      <section class="subpage-hero">
        ...
        <h1>${page.h1}</h1>
        <p>${page.lead}</p>
        <div class="hero-actions"><a class="btn btn-primary" href="tel:+420728505028"><i data-lucide="phone-call" aria-hidden="true"></i>Zavolat kvůli ceně</a><a class="btn btn-dark" href="#poptavka"><i data-lucide="send" aria-hidden="true"></i>Poslat poptávku</a></div>
      </section>
